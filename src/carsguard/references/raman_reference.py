...
@dataclass
class RamanReferenceProfile:
    """
    Reference profile built from real Raman spectra.
    """
    domain: str
    source_type: str
    n_spectra: int
